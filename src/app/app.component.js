...
var AppComponent = (function () {
    ...
    AppComponent.prototype.modificar = function (post) {
        ...
        this.appservice.getJSON(DATA2).subscribe(function (data) { return null; }, function (error) { return _this.errorMessage = error; }, function () { return _this.appservice.getJSON(DATA2).subscribe(function (res) {
            return _this.datos = res;
        }); });
    };
