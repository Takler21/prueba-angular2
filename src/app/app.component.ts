        ...
        this.datos.forEach(post => {
            ...
            if (this.keys2 != Object.keys(post)) {
                this.keys2.forEach(key => {
                    if (this.keys2[key] == null && this.optionals[key] == null) {
                        this.keys2[key] = key;
                        this.optionals[key] = this.keys2[key];
                    }
                });
                Object.keys(post).forEach(key => {
                    if (Object.keys(post)[key] == null && this.optionals[key] == null) {
                        this.optionals[key] = key;
                    }
                });
            }
            //Extraer los campos que no aparecen en todos los post
