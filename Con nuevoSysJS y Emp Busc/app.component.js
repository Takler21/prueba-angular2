...
define(["require", "exports", '@angular/core', './search.service'], function (require, exports, core_1, search_service_1) {
    ...
    var AppComponent = (function () {
        ...
        AppComponent.prototype.buscar = function (post, key) {
            var vacio = false;
            for (var i = 0; i < this.buscado.length; i++) {
                if (this.buscado[key] != null)
                    vacio = true;
            }
            if (vacio)
                return true;
                ...
                if (this.buscado[key] != null) {
                    if (String(post[key]).trim().toUpperCase() == this.buscado[key].trim().toUpperCase())
                        return true;
                    else
                        return false;
                }
