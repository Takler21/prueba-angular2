...
define(["require", "exports", '@angular/core', './search.service'], function (require, exports, core_1, search_service_1) {
    ...
    var AppComponent = (function () {
        ...
        AppComponent.prototype.ngOnInit = function () {
            var _this = this;
            this.appservice.getJSON(DATA2 + "db").subscribe(function (res) {
                return _this.bbdd = Object.keys(res);
            }, function (error) { return _this.errorMessage = error; }, function () {
                api = _this.bbdd[0];
                _this.appservice.getJSON(DATA2 + api + "/").subscribe(function (res) {
        ...
        AppComponent.prototype.addb = function (test) {
            ...
            if (this.validar(test)) {
                this.appservice.add(DATA2 + api + "/", this.test).subscribe(function (data) { return null; }, function (error) { return _this.errorMessage = error; }, function () { return _this.appservice.getJSON(DATA2 + api + "/").subscribe(function (res) {
                    return _this.datos = res;
                }); });
                this.datos.sort;
            }
        ...
        AppComponent.prototype.modificar = function (post) {
            ...
            if (this.validar(post)) {
                this.appservice.update(DATA2 + api + "/", post).subscribe(function (data) { return null; }, function (error) { return _this.errorMessage = error; }, function () { return _this.appservice.getJSON(DATA2 + api + "/").subscribe(function (res) {
                    return _this.datos = res;
                }); });
            }
        };
        ...
        AppComponent.prototype.delet = function (post) {
            var _this = this;
            this.appservice.delete(DATA2 + api + "/", post.id).subscribe(function (data) { return null; }, function (error) { return _this.errorMessage = error; }, function () { return _this.appservice.getJSON(DATA2 + api + "/").subscribe(function (res) {
                return _this.datos = res;
            }); });
        };
        ...
        AppComponent.prototype.changeJson = function (conjunto) {
            ...
            if (api != conjunto) {
                ...
                this.optionals = [];
                this.buscado = [];
                this.appservice.getJSON(DATA2 + api + "/").subscribe(function (res) {
                    return _this.datos = res;
                }, function (error) { return _this.errorMessage = error; }, function () {
                    _this.sacar();
                    _this.test = JSON.parse(JSON.stringify(_this.datos[0]));
